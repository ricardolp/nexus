...
import { loadMockPurchaseOrders } from "./sap-purchase-orders.client.js";
...
export class StubSapInboundAdapter implements SapInboundAdapter {
  ...
  async fetchPurchaseOrderLines(): Promise<
    Awaited<ReturnType<typeof loadMockPurchaseOrders>>['PEDIDOSCOMPRA']
  > {
    const mock = await loadMockPurchaseOrders();
    return mock.PEDIDOSCOMPRA;
  }
